  ...
  return (
    <div className="p-10 max-w-[1200px] mx-auto border border-white shadow-lg">
              ...
              <div className="flex justify-between bg-white mt-5">
                <div className="flex items-center gap-4">
                  <img
                    src={item.icon}
                    alt=""
                    className="w-15 h-15 p-2 shadow-2xl rounded-full border border-white shadow-2xl"
                  />
                  <div>
                ...
                <button
                  ...
                  className="ruonded-lg text-red-500"
                >
      ...
      <div
        ...
        className="w-full text-center bg-purple-600 rounded-xl p-4 text-2xl text-white"
      >
